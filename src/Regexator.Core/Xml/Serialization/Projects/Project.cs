    ...
    public class Project
    {
        internal static Project ToSerializable(Regexator.Project item, string filePath)
        {
            ...
            var project = new Project()
            {
                ...
                FileSystemSearchInfo = FileSystemSearchInfo.ToSerializable(item.Container.FileSystemSearchInfo),
        ...
        internal static Regexator.Project FromSerializable(Project item, string filePath)
        {
            ...
            if (item.FileSystemSearchInfo != null)
                container.FileSystemSearchInfo = FileSystemSearchInfo.FromSerializable(item.FileSystemSearchInfo);
        ...
        [XmlElement("FileSystemSearch")]
        public FileSystemSearchInfo FileSystemSearchInfo { get; set; }
